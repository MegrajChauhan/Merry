...
#define merry_create_dynamic_list(capacity, elem_len, state)                   \
  ((MerryDynamicList *)merry_create_list((capacity), (elem_len), (state)))
#define merry_add_capacity_to_dynamic_list(list, _additional_cap)              \
  merry_add_capacity_to_list((MerryList *)(list), (_additional_cap))
#define merry_dynamic_list_resize(list, factor)                                \
  merry_list_resize_list((MerryList *)(list), (factor))
