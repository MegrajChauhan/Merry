...
// These macro functions are a risk in the sense that we cannot check for the validity of the pointers so we must depend on the caller that the pointers are valid
...
// Here, factor represents the number of times the current capacity is to be multiplied
